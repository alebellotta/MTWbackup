...
OptionPrices = data.frame(Call@price, Cbs, Cbsmc[[1]], Cbsmcav[[1]], Cbsmccv[[1]], HestonCall$pricesAnalytic, JumpCall, A)
colnames(OptionPrices) = c("BSbi", "BSf", "BSMC", "BSMCav", "BSMCcv", "HESTON", "JUMP", "FBS")
rownames(OptionPrices) = "Call Price"
View(OptionPrices)
